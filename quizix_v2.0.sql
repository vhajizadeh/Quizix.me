...
CREATE TABLE `questions` (
  ...
  `choice_a` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `choice_b` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `choice_c` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `choice_d` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
